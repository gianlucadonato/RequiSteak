...
class ComponentsControllerTest < ActionController::TestCase
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post :create, component: { ancestry: @component.ancestry, description: @component.description, package_id: @component.package_id, title: @component.title, use: @component.use }
    end
  ...
  test "should update component" do
    patch :update, id: @component, component: { ancestry: @component.ancestry, description: @component.description, package_id: @component.package_id, title: @component.title, use: @component.use }
    assert_redirected_to component_path(assigns(:component))
  end
