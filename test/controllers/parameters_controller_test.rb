...
class ParametersControllerTest < ActionController::TestCase
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post :create, parameter: { description: @parameter.description, name: @parameter.name, parameter_type: @parameter.parameter_type }
    end
  ...
  test "should update parameter" do
    patch :update, id: @parameter, parameter: { description: @parameter.description, name: @parameter.name, parameter_type: @parameter.parameter_type }
    assert_redirected_to parameter_path(assigns(:parameter))
  end
