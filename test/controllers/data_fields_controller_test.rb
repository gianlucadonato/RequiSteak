...
class DataFieldsControllerTest < ActionController::TestCase
  ...
  test "should create data_field" do
    assert_difference('DataField.count') do
      post :create, data_field: { description: @data_field.description, name: @data_field.name, type: @data_field.type, typology: @data_field.typology, unit_id: @data_field.unit_id, visibility: @data_field.visibility }
    end
  ...
  test "should update data_field" do
    patch :update, id: @data_field, data_field: { description: @data_field.description, name: @data_field.name, type: @data_field.type, typology: @data_field.typology, unit_id: @data_field.unit_id, visibility: @data_field.visibility }
    assert_redirected_to data_field_path(assigns(:data_field))
  end
